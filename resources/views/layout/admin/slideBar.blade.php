<div class="sidebar">
            <nav class="sidebar-nav">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a href="/admin/catelogys" class="nav-link ">
                            <i class="icon icon-speedometer"></i> Catelogies
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="/admin/gender" class="nav-link ">
                            <i class="icon icon-speedometer"></i> Gender
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="/admin/product" class="nav-link ">
                            <i class="icon icon-speedometer"></i> Product
                        </a>
                    </li>
